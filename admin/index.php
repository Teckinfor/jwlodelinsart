                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    <form action="/modules/admindbconnect.php" method="POST">
                                        ...
                                        <input name="title" type="text" id="title" class="form-control" maxlength="64">
                                        <label for="content" class="mt-2 form-label">Message</label>
                                        <textarea name="content" type="text" id="content" class="form-control" maxlength="2056"></textarea>
